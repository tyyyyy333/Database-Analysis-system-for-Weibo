...
class User(Base):
    ...
    # 添加与UserCelebrity的关联
    celebrity_relations = relationship("UserCelebrity", 
                                     back_populates="user",
                                     overlaps="monitored_celebrities")
...
class UserCelebrity(Base):
    ...
    user = relationship("User", 
                       back_populates="celebrity_relations",
                       overlaps="monitored_celebrities")
    celebrity = relationship("Celebrity", 
                           back_populates="user_relations",
                           overlaps="monitoring_users,monitored_celebrities")
...
class Celebrity(Base):
    ...
    monitoring_users = relationship("User", 
                                  ...
                                  overlaps="celebrity_relations,user")
    user_relations = relationship("UserCelebrity", 
                                back_populates="celebrity",
                                overlaps="monitored_celebrities,monitoring_users")
